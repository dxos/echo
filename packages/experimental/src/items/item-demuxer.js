...
exports.createItemDemuxer = function (itemManager) {
    ...
    var itemStreams = new util_1.LazyMap(function () { return new stream_1.Readable({ objectMode: true, read: function () { } }); });
    ...
    return new stream_1.Writable({
        ...
        write: function (message, _, callback) { return __awaiter(void 0, void 0, void 0, function () {
            var itemId, genesis, mutation, stream, itemType, modelType, item, __type_url, stream_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        util_1.assertAnyType(message, 'dxos.echo.testing.FeedMessage');
                    ...
                    case 2:
                        ...
                        //
                        if (mutation) {
                            stream.push({ envelope: envelope });
                            return [2 /*return*/];
                        }
                        __type_url = operation.__type_url;
                        switch (__type_url) {
                            //
                            // Item mutation.
                            //
                            case 'dxos.echo.testing.TestItemMutation': {
                                util_1.assumeType(operation);
                                assert_1.default(operation);
                                stream_2 = itemStreams.getOrInit(itemId);
                                stream_2.push({ envelope: payload });
                                break;
                            }
                            default:
