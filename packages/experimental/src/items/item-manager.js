...
var ItemManager = /** @class */ (function (_super) {
    ...
    ItemManager.prototype._createWriteStream = function (itemId) {
    ...
    ItemManager.prototype.createItem = function (itemType, modelType) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, waitForCreation, callback, itemId, writable;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        writable = this._createWriteStream(itemId);
                        return [4 /*yield*/, pify_1.default(writable.write.bind(writable))({
    ...
    ItemManager.prototype.constructItem = function (itemId, itemType, modelType, readable) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                writable = this._createWriteStream(itemId);
                model = this._modelFactory.createModel(modelType, itemId, readable, writable);
