...
var TestModel = /** @class */ (function (_super) {
    ...
    TestModel.prototype.processMessage = function (envelope) {
        return __awaiter(this, void 0, void 0, function () {
            var mutation, key, value;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mutation = envelope.operation;
                        assert_1.default(mutation);
                        util_1.assertTypeUrl(mutation, 'dxos.echo.testing.TestItemMutation');
