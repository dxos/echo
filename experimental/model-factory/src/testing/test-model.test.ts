...
describe('test model', () => {
  ...
  test('mutations feedback loop', async () => {
    ...
    const transform = createTransform<
      prototol_dxos.echo.testing.TestItemMutation, ModelMessage<prototol_dxos.echo.testing.TestItemMutation>
      >(
        async (mutation: prototol_dxos.echo.testing.TestItemMutation) => {
          const message: ModelMessage<prototol_dxos.echo.testing.TestItemMutation> = {
            meta: {
              feedKey,
              seq
            },
